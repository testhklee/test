...
public class SoupSearchDto {
	...
	private int currentMember;			//현재 멤버 수
	
	public SoupSearchDto() {
		super();
	}

	public SoupSearchDto(int soupNo, String soupGubun, String soupTitle, String soupField1, String soupField2,
			Date soupRecruitEndDate, String soupRecruitEndTime, int soupMemberMin, int soupMemberMax, String soupAddr1,
			String soupAddr2, Date soupStartDate, Date soupEndDate, String soupDay, String soupStartTime,
			String soupEndTime, int soupPrice, int memberNo, String memberEmail, String memberName, String memberFace) {
		super();
		this.soupNo = soupNo;
