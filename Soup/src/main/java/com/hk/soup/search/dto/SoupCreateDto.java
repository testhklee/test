...
public class SoupCreateDto {
	...
	public SoupCreateDto() {
		super();
	}

	public SoupCreateDto(String memberNo, String memberName, int soupNo, String soupGubun, String soupTitle,
			String soupField1, String soupField2, String soupRecruitEndDate, String soupRecruitEndTime,
			int soupMemberMin, int soupMemberMax, String soupContent, String soupCreateDate, String soupStatus,
			String soupAddr1, String soupAddr2, String soupStartDate, String soupEndDate, String soupDay,
			String soupStartTime, String soupEndTime, int soupPrice, String soupIntroVideo) {
		super();
