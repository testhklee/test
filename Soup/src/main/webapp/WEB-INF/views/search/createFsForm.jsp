...
<section id="price" class="price sections">
  <div class="padd container">
	<h1>스터디 생성</h1>
	<!-- Form starts.  -->
		<form class="form-horizontal" role="form" action="createFs.do" method="post">
			<input type="hidden" name="soupGubun" value="FS"/>
			...
			<div class="form-group">
			  ...
			  <div class="col-md-8">
				<input type="time" class="form-control" name="soupStartTime" id="soupStartTime" required="required">
				<input type="time" class="form-control" name="soupEndTime" id="soupEndTime" required="required">
			  </div>
			</div>
			<div class="form-group">
